...
(https://docs.google.com/spreadsheets/d/1bSb1-S9qOf46fNH8quyoFpcjcTuBMj_EdSPchOuFULY/edit?usp=sharing).
...
**Entradas:**
R.F. 01 - Registro de Usuários: Permite cadastrar as pessoas que acessarão o sistema, vinculando-as a um perfil específico para controle de permissões.

Dados necessários: nome, e-mail, senha, fk_idPerfil.

Usuários: Gestor.

R.F. 02 - Registro de Produtos: Permite incluir os itens do cardápio da padaria no sistema para que fiquem disponíveis para venda e visualização.

Dados necessários: nome_produto, descrição, preço, quantidade_estoque.

Usuários: Gestor.

R.F. 03 - Registro de Insumos: Permite cadastrar as matérias-primas utilizadas na produção (farinha, fermento, etc.) para controle de estoque de depósito.

Dados necessários: nome, unidade_medida, quantidade_estoque.

Usuários: Gestor.

R.F. 04 - Registro de Ficha Técnica: Estabelece a ligação entre um produto final e os insumos necessários para produzi-lo.

Dados necessários: fk_idProduto, fk_idInsumo, quantidade_necessaria.
